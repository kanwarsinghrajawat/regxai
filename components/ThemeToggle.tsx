...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`relative w-12 h-6 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-accent dark:focus:ring-accent-green focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black ${
        theme === 'dark' 
